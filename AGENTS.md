...
**Use few words. Use plain words. Say the useful thing first.**

- Lead with the answer, decision, or result.
- Prefer short sentences and concrete language.
- Cut greetings, filler, repetition, and play-by-play narration.
- Do not explain obvious code or restate the request.
- Add detail only when it changes a decision or prevents a mistake.
- When one sentence is enough, stop after one sentence.
